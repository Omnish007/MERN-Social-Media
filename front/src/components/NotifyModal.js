...
const NotifyModal = () => {
    ...
    const handleDeleteAll = () => {
        ...
        if (window.confirm(`You have ${newArr.length} unread notification. Are you sure you want to delete all?`)) {
    ...
    return (
        <div style={{ minWidth: "300px" }}>
            ...
            <hr className="mt-0" />
            {
                ...
                <img src={nonotification} alt="nonotification" className="w-100" />
            }
